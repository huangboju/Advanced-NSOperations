...
@objc protocol OperationQueueDelegate: NSObjectProtocol {
    @objc optional func operationQueue(_ operationQueue: CustomOperationQueue, willAddOperation operation: Operation)
    @objc optional func operationQueue(_ operationQueue: CustomOperationQueue, operationDidFinish operation: Operation, withErrors errors: [NSError])
}
...
class CustomOperationQueue: OperationQueue {
    ...
    override func addOperation(_ operation: Operation) {
        if let op = operation as? CustomOperation {
