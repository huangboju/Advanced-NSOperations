...
class ExclusivityController {
    ...
    fileprivate var operations: [String: [CustomOperation]] = [:]
    ...
    func addOperation(_ operation: CustomOperation, categories: [String]) {
        /*
    ...
    func removeOperation(_ operation: CustomOperation, categories: [String]) {
        serialQueue.async {
            for category in categories {
    ...
    fileprivate func noqueue_addOperation(_ operation: CustomOperation, category: String) {
    ...
    fileprivate func noqueue_removeOperation(_ operation: CustomOperation, category: String) {
