...
class GroupOperation: CustomOperation {
    ...
    */
    final func aggregateError(_ error: Error) {
        aggregatedErrors.append(error as NSError)
    }
...
extension GroupOperation: OperationQueueDelegate {
    final func operationQueue(_ operationQueue: CustomOperationQueue, willAddOperation operation: Operation) {
    ...
    final func operationQueue(_ operationQueue: CustomOperationQueue, operationDidFinish operation: Operation, withErrors errors: [NSError]) {
